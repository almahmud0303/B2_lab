        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Edit Department Notice: ' . $notice->title) }}
                </h2>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-6">Edit Department Notice</h3>
                    
                    <form action="{{ route('department-head.notices.update', $notice) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    @php
                                        $selectedRoles = old('target_roles', $notice->target_roles ?? ['student', 'teacher']);
                                    @endphp
                                    <div class="flex items-center">
